...
const doshaData = [
  { dosha: "Vata", current: 65, target: 80 },
  { dosha: "Pitta", current: 75, target: 70 },
  { dosha: "Kapha", current: 70, target: 75 },
]
    ...
    <AuthGuard requiredRole="patient">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="dosha" className="space-y-6">
          <Card className="border-emerald-200">
            <CardHeader>
              <CardTitle className="text-emerald-900">Dosha Balance Analysis</CardTitle>
              <CardDescription>Monitor your constitutional balance through treatment</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div>
                  <ResponsiveContainer width="100%" height={300}>
                    <RadarChart data={doshaData}>
                      ...
                      <PolarAngleAxis dataKey="dosha" tick={{ fill: "#065f46" }} />
                      <PolarRadiusAxis angle={90} domain={[0, 100]} tick={{ fill: "#065f46", fontSize: 12 }} />
                      <Radar
                        name="Current"
                        dataKey="current"
                        stroke="#059669"
                  ...
                  {doshaData.map((dosha, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="font-semibold text-emerald-900">{dosha.dosha}</h4>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="text-emerald-900">{dosha.current}%</span>
                        </div>
                        <Progress value={dosha.current} className="h-2" />
                        <div className="flex justify-between text-sm">
                          <span className="text-emerald-700">Target</span>
                          <span className="text-emerald-900">{dosha.target}%</span>
                        </div>
                        <Progress value={dosha.target} className="h-2 opacity-50" />
                      </div>
                    </motion.div>
                  ))}
                </div>
